 <div id="header">
            ...
            <div class="container">
                <div class="pull-left auto-width-left">
                    <ul class="top-menu menu-beta l-inline">
                        <li><a href=""><i class="fa fa-home"></i> TP Cà Mau, Tỉnh Cà Mau</a></li>
                        <li><a href=""><i class="fa fa-phone"></i> 0290 227777</a></li>
                    </ul>
                </div>
                <div class="pull-right auto-width-right">
                    <ul class="top-details menu-beta l-inline">
                       @if(Auth::check())
                        <?php $a = Auth::user()->id ?>
                        <li><a href="{{asset('thongtincanhan/'.$a)}}"><i class="fa fa-user"></i>Tài khoản</a></li>
                        
                        <li><a href="">Xin chào bạn {{Auth::user()->full_name}}
                        <img src="" alt="">
                        </a></li> 
        ...
        <div class="header-body">
            <div class="container beta-relative">
                <div class="pull-left">
                    <a href="{{route('trangchu')}}" id="logo"><img src="{{asset('source/home/assets/dest/images/logo-cmt.png')}}" width="200px" alt=""></a>
                </div>
                        ...
                        <div class="cart">
                            ...
                            <div class="beta-dropdown cart-body">
                                ...
                                <div class="cart-item">
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#"><img src="{{asset('source/home/image/product/'.$product['item']['image'])}}" alt=""></a>
