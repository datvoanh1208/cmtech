...
<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row" >
                    ...
                    @endif
                        <form action="{{asset('thongtincanhan/'.$user->id)}}" method="POST">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control password" name="old_password" placeholder="Nhập password" disabled="" />
